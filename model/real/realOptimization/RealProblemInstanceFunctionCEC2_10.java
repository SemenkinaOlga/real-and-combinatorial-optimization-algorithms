...
public class RealProblemInstanceFunctionCEC2_10 extends RealProblemInstance {

    @Override
    public String getName(){ return "CEC2021 Rastrigin’s Function 10"; }
    ...
    public Double calculateObjectiveFunction(List<Double> data) {
        ...
        for (int i = 0; i < getDimension(); i++){
            x = data.get(i);
            res += x * x - 10 * Math.cos(2 * Math.PI * x) + 10;
        }
        return  res;
    }
