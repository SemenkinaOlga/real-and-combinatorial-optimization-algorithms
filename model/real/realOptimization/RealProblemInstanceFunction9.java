...
public class RealProblemInstanceFunction9 extends RealProblemInstance {

    public static double SQRT5 = Math.sqrt(5);

    @Override
    public String getName(){ return "Katnikov function"; }

    @Override
    public double getLeftBound() { return -5; }
